...
const page = () => {
  ...
  const [modalType, setModalType] = useState<"filter" | "add-location" | null>(
    null,
  );
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start mb-6">
        ...
        <div className="flex gap-3 w-full md:w-auto justify-end">
          <button className="inline-flex items-center justify-center gap-1 px-4 py-2.5 border border-gray-200 rounded-lg bg-white text-[14px] font-semibold text-gray-700 whitespace-nowrap shadow-sm">
            ...
            >
              <path
                d="M9.99967 6.66699V1.66699L8.33301 3.33366"
                stroke="#292D32"
                strokeWidth="1.25"
                strokeLinecap="round"
              ...
              />
              <path
                d="M5.83333 10C2.5 10 2.5 11.4917 2.5 13.3333V14.1667C2.5 16.4667 2.5 18.3333 6.66667 18.3333H13.3333C16.6667 18.3333 17.5 16.4667 17.5 14.1667V13.3333C17.5 11.4917 17.5 10 14.1667 10C13.3333 10 13.1 10.175 12.6667 10.5L11.8167 11.4"
                stroke="#292D32"
                strokeWidth="1.25"
                strokeMiterlimit="10"
                strokeLinecap="round"
        ...
        <div className="font-sans px-1">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-[15px] font-medium">
              Narrow down by branch, time, and metrics
            </p>
          </div>
          ...
          <div className="mb-5">
            ...
            {showCustomGroupInput && (
              <p className="text-gray-400 text-xs mt-2 leading-relaxed">
                Create a group name if you would like to categorize
                branches/locations based on regions, state or however you would
                like
              </p>
            )}
          </div>
