import { RevenueIcon, TransactionIcon, StaffIcon, InventoryIcon, ArrowDownIcon, ArrowUpIcon, CalendarIcon, DownloadIcon } from "@/components/icons/svgs";
...
export default async function Page() {
    ...
    return (
        <main className="p-6">
            <Header heading="Good morning, Yetty Mama Lounge 👋" subHeading="Here's what's happening with your business today — Tuesday, Mar 24, 2026" />
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar">
                        <div className="divide-y divide-gray-100">
                            {MOCK_TRANSACTIONS.map((txn) => {
                                ...
                                return (
                                    <div key={txn.id} className="flex items-center justify-between p-4 bg-white">
                                        ...
                                        <div className={`font-medium text-[14px] whitespace-nowrap ml-4 ${isPositive ? 'text-[#04802E]' : 'text-[#CB1A14]'}`}>
