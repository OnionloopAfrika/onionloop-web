...
import { RightArrowIcon, Separator, UpwordIcon } from "@/components/icons/svgs";
import { SearchInput } from "@/components/ui/search-input";
import { useState } from "react";
import { Modal } from "@/components/ui/modal";
import { Items, OrderInfo } from "@/components/cashier/order-details";

export default function Page() {
  const [showOrderdetails, setShowOrderDetails] = useState(false);

  const items = [
    { item: "Cocacola", nos: "2", amount: "₦1,000" },
    { item: "Meat pie", nos: "4", amount: "₦2,000" },
    { item: "Sprite", nos: "2", amount: "₦2,000" },
    { item: "Fanta", nos: "2", amount: "₦2,000" },
    { item: "Donuts", nos: "2", amount: "₦2,000" },
    { item: "Donuts", nos: "2", amount: "₦2,000" },
  ];
  ...
  return (
    <>
      <div className="space-y-[40px]">
        <Breadcrumb firstTab="Sales" secondTab="Staff order details" />

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl p-[16px] shadow-[0_1px_3px_rgba(0,0,0,0.1)]">
            <div className="flex items-center gap-[12px] mb-6">
              <div className="w-20 h-20 rounded-full overflow-hidden flex-shrink-0">
                <Image
                  src="/images/zinny.svg"
                  alt="Adaeze Nwosu"
                  width={80}
                  height={80}
              ...
              <div>
                <h3 className="font-[600] text-[16px] text-[#131313]">
                  Adaeze Nwosu
                </h3>
            ...
            <div className="space-y-[12px]">
              <div className="flex justify-between items-center">
                ...
                <span className="font-[600] text-[16px] text-[#131313]">
                  ₦450,000.00
                </span>
              </div>
              <div className="flex justify-between items-center">
                ...
                <span className="bg-[#04802E] text-white px-[12.64px] py-1.5 rounded-full text-[14px] font-medium">
                  Active
                </span>
              </div>
              <div className="flex justify-between items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white border border-gray-100 rounded-[8px] p-[12px] space-y-[8px] flex flex-col gap-[8px] justify-between">
              ...
              <div className="flex items-center gap-1.5">
                <UpwordIcon className="text-[#04802E] w-[12px] h-[12px]" />
                <span className="text-[12px] text-[#04802E] font-medium">
                  12% from last month
                </span>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-[8px] p-[12px] space-y-[8px] flex flex-col gap-[8px] justify-between">
              <p className="text-[20px] font-[600] text-[#000000]">10</p>
              <p className="font-[500] text-[10px] text-[#6C6C6C]">
                Today's Order
              </p>
              <div className="flex items-center gap-1.5">
            ...
            <div className="bg-white border border-gray-100 rounded-[8px] p-[12px] space-y-[8px] flex flex-col gap-[8px] justify-between">
              <p className="text-[20px] font-[600] text-[#000000]">90</p>
              <p className="font-[500] text-[10px] text-[#6C6C6C]">
                This Week’s Sales
              </p>
              <div className="flex items-center gap-1.5">
            ...
            <div className="bg-white border border-gray-100 rounded-[8px] p-[12px] space-y-[8px] flex flex-col gap-[8px] justify-between">
              <p className="text-[20px] font-[600] text-[#000000]">₦4,000.00</p>
              <p className="font-[500] text-[10px] text-[#6C6C6C]">
                Average Order Value
              </p>
              <div className="flex items-center gap-1.5">
        ...
        <div className="space-y-[24px]">
          ...
          <div className="space-y-[15px]">
            <div className="space-y-[8px]">
              <OrderInfo title="Date:" value="03 Feb, 2026 at 9:00 AM" />
              <OrderInfo title="Processed by:" value="David John" />
              <OrderInfo title="Customer:" value="@joshua_akin(You)" />
            </div>
            ...
            <div className="space-y-[8px]">
              ...
              <OrderInfo title="Number of products sold" value="6" />
              <OrderInfo title="VAT (7.5%)" value="₦862.50" />
            </div>
            <div className="flex justify-between items-center">
              <span className="font-[500] text-[12px] text-[#242424]">
                Total Bills
              </span>
              <span className="font-[600] text-[14px] text-[#363636]">
                ₦50,000.00
              </span>
            </div>
          </div>
