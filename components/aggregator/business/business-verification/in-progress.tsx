      ...
      >
        <div className="space-y-[16px]">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="py-[2px] px-[12px] bg-[#E7F6EC] flex justify-center items-center rounded-full font-[500] text-[13.05px] text-[#04802E] h-[26px]">
              In Progress
            </span>
          </div>

          <p className="font-[500] text-[12px] text-[#363636]">
            Your verification has been approved and business address has been
            verified
          </p>
