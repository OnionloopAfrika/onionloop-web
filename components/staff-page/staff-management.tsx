...
export default function StaffManagement() {
  ...
  const [modalType, setModalType] = useState<
    "profile" | "edit" | "deactivate" | "remove" | "invite" | "success" | null
  >(null);
    ...
    <div className="min-h-screen">
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start mb-6">
        ...
        <div className="flex gap-3 w-full md:w-auto justify-end">
          <button
            onClick={() => router.push(`/${subdomain}/staffs/leave-request`)}
      ...
      >
        <div className="max-h-[75vh] overflow-y-auto z-10">
          <div className="text-center mb-8">
            <h2 className="text-[24px] font-bold text-[#131313] mb-2">
              Invite New Staff
            </h2>
          ...
          <div className="flex gap-4">
            <Button
              variant="secondary"
              className="flex-1 !bg-[#F7F7F7] !py-4"
              onClick={closeModal}
            >
              Cancel
            </Button>
      ...
      >
        <div className="max-h-[85vh] overflow-y-auto px-1">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            />
            <span
              className={`text-white text-[10px] px-4 py-1 rounded-full font-bold ${selectedStaff?.status === "Active" ? "bg-[#00634B]" : "bg-[#98A2B3]"}`}
            >
            ...
            {[
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="p-2.5 bg-[#FFF] shadow-sm rounded-lg">
                    {item.icon}
                  </div>
                ...
                <span className="font-semibold text-[#131313] text-[14px]">
                  {item.value}
                </span>
              </div>
            ))}
          ...
          <div className="flex gap-4 mt-10">
            ...
            <Button variant="primary" className="flex-1 !bg-[#004D3C]">
              Send message
            </Button>
          </div>
        </div>
