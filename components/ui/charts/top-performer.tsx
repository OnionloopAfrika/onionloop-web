...
export default function TopPerformingLocations({ data = mockLocationData }: TopPerformingLocationsProps) {
    return (
        <div className="w-full p-4 flex flex-col h-full">
            <div className="flex items-center justify-between mb-10">
                <h2 className="text-[20px] font-semibold text-gray-900 tracking-tight">Top Performing Locations</h2>
