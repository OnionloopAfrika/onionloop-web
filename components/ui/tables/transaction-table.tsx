...
const mockTransactions: Transaction[] = [
    { id: "TNX 18377489930303362249", location: "Ikoyi branch", amount: 500000, processedBy: "Titi Folarin", transType: "Bank Transfer", status: "Successful", date: "03 Feb, 2026 at 9:00 AM", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "KFC Holdings", fee: 0, description: "Money" },
    { id: "TXN-7820", location: "Gbagada", amount: 128000, processedBy: "Titi Folarin", transType: "Payment", status: "Successful", date: "2025-03-24 09:12", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "Pizza Hut", fee: 0, description: "Food" },
    { id: "TXN-7819", location: "Ojota", amount: 6500, processedBy: "Mary Olarenwaju", transType: "Bank Transfer", status: "Successful", date: "2025-03-24 09:12", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "Munchies", fee: 0, description: "Logistics" },
    { id: "TXN-7818", location: "St. Claire", amount: 3200, processedBy: "David Anigbogu", transType: "Bank Transfer", status: "Successful", date: "2025-03-24 09:12", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "David Anigbogu", fee: 0, description: "Refund" },
    { id: "TXN-7817", location: "Egbeda", amount: 28400, processedBy: "Samuel Saidu", transType: "Payment", status: "Pending", date: "2025-03-24 09:12", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "Supermarket", fee: 0, description: "Groceries" },
    { id: "TXN-7816", location: "Ajegunle", amount: 15000, processedBy: "Adanma Dappa", transType: "Payment", status: "Successful", date: "2025-03-24 09:12", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "Adanma Dappa", fee: 0, description: "Services" },
    { id: "TXN-7815", location: "Mushin", amount: 9300, processedBy: "Kemi Saidu", transType: "Payment", status: "Failed", date: "2025-03-24 09:12", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "Kemi Saidu", fee: 0, description: "Subscription" },
    { id: "TXN-7814", location: "Festac", amount: 22100, processedBy: "Titi Folarin", transType: "Bank Transfer", status: "Successful", date: "2025-03-24 09:12", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "Titi Folarin", fee: 0, description: "Transfer" },
    { id: "TXN-7813", location: "Agungi", amount: 7600, processedBy: "Titi Folarin", transType: "Bank Transfer", status: "Successful", date: "2025-03-24 09:12", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "Boutique", fee: 0, description: "Clothes" },
    { id: "TXN-7812", location: "Gbagi", amount: 45000, processedBy: "Titi Folarin", transType: "Bank Transfer", status: "Successful", date: "2025-03-24 09:12", senderName: "OLUROMOKE BALOGUN", recipientAccountName: "Gas Station", fee: 0, description: "Fuel" },
];
...
export default function TransactionsTable() {
    ...
    const getStatusBadge = (status: Transaction["status"]) => {
        if (status === "Successful") {
            return <span className="px-3 py-1 rounded-full text-[12px] font-medium bg-[#E8F5E9] text-[#04802E]">Successful</span>;
        }
        if (status === "Pending") {
            return <span className="px-3 py-1 rounded-full text-[12px] font-medium bg-[#FFF3E0] text-[#E65100]">Pending</span>;
        }
        return <span className="px-3 py-1 rounded-full text-[12px] font-medium bg-[#FFEBEE] text-[#C62828]">Failed</span>;
    };
